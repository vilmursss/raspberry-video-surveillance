# Class for recipes that depend on app-utils
# This class provides the SRC_URI and checksums for all dependencies used by app-utils
# and its dependent recipes

# Include the app-utils source
SRC_URI += "file://${VOLUME_WORKDIR}/libs/app-utils"

# Include all the crate dependencies from app-utils
SRC_URI += " \
